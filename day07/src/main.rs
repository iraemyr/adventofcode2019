...
fn main() {
    ...
    let v: Vec<i32> = contents
        ...
        .collect();
    println!("{}", part1(v.clone())); // 95757
    println!("{}", part2(v)); // 4275738
}
